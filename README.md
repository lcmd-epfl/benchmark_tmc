...
It includes three datasets: **TM-GSspinPlus**, **tmPHOTO**, and **OctaKulik**.   See the included [README.md](data/README.md) for details.
...
```
- SLATM, FCHL: [qml2](https://github.com/qml2code/qml2)  
```bash
git clone https://github.com/qml2code/qml2
cd qml2
pip install -e .
```
...
- Molecular representation generation: [`representations/`](representations/)  
  See the included [README.md](representations/README.md) for details.

- Kernel ridge regression with 10-fold cross-validation using Q-stack: [`krr/`](krr/)  
